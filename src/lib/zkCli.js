...
export default class zkCli {
     ...
     */
    watch(path, callback) {
        this.client.aw_get(path, watchCallback(this.watch)(path, callback), formatCallback(callback))
    }
    ...
    watchDir(path, callback) {
        this.client.aw_get_children(path, watchCallback(this.watchDir(path, callback)), formatCallback(callback))
    }
}